...
**Resource**<br>
**Resource Owner**<br>
Owner of the resource ._An entity capable of granting access to a protected resource_.
**Client**<br>
Client application. _An application making request to protected resource with authorization_.
**Auth Server**<br>
